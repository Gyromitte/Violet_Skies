...
try {
    ...
    $sql = "SELECT EVENTO.ID AS ID_EVENTO, EVENTO.NOMBRE AS 'NOMBRE DEL EVENTO', CUENTAS.NOMBRE AS 'NOMBRE DEL CLIENTE', SALONES.NOMBRE AS 'NOMBRE DEL SALÓN', COMIDAS.NOMBRE AS 'MENÚ', EVENTO.ESTADO,
