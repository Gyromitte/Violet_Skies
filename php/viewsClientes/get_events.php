...
try {
    ...
    $sql = "SELECT EVENTO.ID AS ID_EVENTO, EVENTO.NOMBRE AS 'NOMBRE DEL EVENTO', CUENTAS.NOMBRE AS 'NOMBRE DEL CLIENTE',COMIDAS.ID AS 'ID_MENU',SALONES.NOMBRE AS 'NOMBRE DEL SALÓN', COMIDAS.NOMBRE AS 'MENÚ', EVENTO.ESTADO,
    EVENTO.F_EVENTO AS 'FECHA DEL EVENTO', DETALLE_EVENTO.SALON AS 'ID_SALON', DETALLE_EVENTO.INVITADOS AS INVITADOS
    FROM 
