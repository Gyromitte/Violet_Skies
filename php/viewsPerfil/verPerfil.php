...
<div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" readonly class="col-sm-2 col-form-label" value="<?php echo $_SESSION['nombre']; ?>">
        </div>
    </div>
    <div class="mb-3 row">
        <label class="col-sm-2 col-form-label">Apellido paterno:</label>
        <div class="col-sm-10">
            <input type="text" readonly class="col-sm-2 col-form-label" value="<?php echo $_SESSION['apellido_paterno']; ?>">
        </div>
    </div>
    <div class="mb-3 row">
        <label class="col-sm-2 col-form-label">Apellido materno:</label>
        <div class="col-sm-10">
            <input type="text" readonly class="col-sm-2 col-form-label" value="<?php echo $_SESSION['apellido_materno']; ?>">
        </div>
    </div>
    <div class="mb-3 row">
        <label class="col-sm-2 col-form-label">Teléfono:</label>
        <div class="col-sm-10">
            <input type="text" readonly class="col-sm-2 col-form-label" value="<?php echo $_SESSION['telefono']; ?>">
        </div>
    </div>
    <div class="mb-3 row">
        <label class="col-sm-2 col-form-label">Correo:</label>
        <div class="col-sm-10">
            <input type="text" readonly class="col-sm-2 col-form-label" value="<?php echo $_SESSION['correo']; ?>">
        </div>
    </div>
    <div class="mb-3 row">
