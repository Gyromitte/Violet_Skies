<?php
     if ($_SERVER['REQUEST_METHOD'] === 'POST')
     {
        ...
        if($orden=="porcreacion"){
            ...
            E.ESTADO='PENDIENTE') AND NOT EXISTS (SELECT 1 FROM EVENTO_EMPLEADOS EE
            ...
            FROM EVENTO E JOIN CUENTAS CU ON E.CLIENTE=CU.ID JOIN DETALLE_EVENTO DE ON
            DE.ID=E.ID JOIN SALONES S ON S.ID=DE.SALON WHERE E.ESTADO='EN PROCESO'OR 
            E.ESTADO='PENDIENTE' ORDER BY E.F_EVENTO DESC";
        }
            ...
            FROM EVENTO E JOIN CUENTAS CU ON E.CLIENTE=CU.ID JOIN DETALLE_EVENTO DE ON
            DE.ID=E.ID JOIN SALONES S ON S.ID=DE.SALON WHERE E.ESTADO='EN PROCESO'OR 
            E.ESTADO='PENDIENTE' ORDER BY E.F_EVENTO ASC";
        }
